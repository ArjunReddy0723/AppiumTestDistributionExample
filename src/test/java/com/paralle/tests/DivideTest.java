...
public class DivideTest extends UserBaseTest {
	...
	@Test
	public static void divideTest() throws Exception {

		System.out.println("ThreadName: " + Thread.currentThread().getName()
				+ Thread.currentThread().getStackTrace()[1].getClassName());
		calculationPage = new CalculationPage(driver);
		calculationPage.acceptPopUp(driver).clickNine(driver).clickDivide(driver).clickTwo(driver).clickEqual(driver);
	}
}
